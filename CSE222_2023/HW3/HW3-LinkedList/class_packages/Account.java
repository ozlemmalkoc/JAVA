...
public class Account {
  ...
  private LinkedList < Account > blockedPeople;
  private LinkedList < Account > peopleWhoBlocked;
  ...
  public Account(int accountId, String username, String birthdate, String location) {
    ...
    blockedPeople = new LinkedList < Account > ();
    peopleWhoBlocked = new LinkedList < Account > ();
    history = new LinkedList < String > ();
    System.out.println("An account with username " + this.username + " has been created.");
  }
  public LinkedList < Account > getBlockedPeople() {
    return blockedPeople;
  }
  public void setBlockedPeople(LinkedList < Account > blockedPeople) {
    this.blockedPeople = blockedPeople;
  }
  public LinkedList < Account > getPeopleWhoBlocked() {
    return peopleWhoBlocked;
  }
  public void setPeopleWhoBlocked(LinkedList < Account > peopleWhoBlocked) {
  ...
  public void viewPostsInteractions(Account user, LinkedList < Account > accounts) {
    if (isLogin == true) {
      if (isBlockedPerson(user) == false && user.getBlockedPeople().contains(this)==false) {
