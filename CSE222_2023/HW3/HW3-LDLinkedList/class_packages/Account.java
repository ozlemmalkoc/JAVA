...
public class Account {
  ...
  private LDLinkedList < Account > blockedPeople;
  private LDLinkedList < Account > peopleWhoBlocked;
  ...
  public Account(int accountId, String username, String birthdate, String location) {
    ...
    blockedPeople = new LDLinkedList < Account > ();
    peopleWhoBlocked = new LDLinkedList < Account > ();
    history = new LDLinkedList < String > ();
    System.out.println("An account with username " + this.username + " has been created.");
  }
  public LDLinkedList < Account > getBlockedPeople() {
    return blockedPeople;
  }
  public void setBlockedPeople(LDLinkedList < Account > blockedPeople) {
    this.blockedPeople = blockedPeople;
  }
  public LDLinkedList < Account > getPeopleWhoBlocked() {
    return peopleWhoBlocked;
  }
  public void setPeopleWhoBlocked(LDLinkedList < Account > peopleWhoBlocked) {
  ...
  public void viewPostsInteractions(Account user, LDLinkedList < Account > accounts) {
    if (isLogin == true) {
      if (isBlockedPerson(user) == false && user.getBlockedPeople().contains(this)==false) {
